...
const textArray = [
  "Footwear that let you fly",
  "Agrata",
  "Due to COVID-19 restrictions and partial lockdown , customer may experience some difficulty and a slight delay in order deliveries.",
  "Agrata",
];
